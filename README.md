...
<h4>담당 역할</h4>
<ul>
  <li>게임 진행 및 자산 관리 관련 REST API 개발</li>
  <li>주식 매수·매도, 보유 자산 조회, 투자 결과 정산 로직 구현</li>
  <li>게임 상태 저장 및 데이터베이스 연동 기능 개발</li>
</ul>
...
<!-- gitAnimals -->
<h2 style="border-bottom: 1px solid #21262d; color: #c9d1d9;"> 👩🏻‍🌾 My little farm </h2> <br> 
<div align="center">
  <a href="https://www.gitanimals.org/en_US?utm_medium=image&utm_source=HYE77&utm_content=farm">
    <img
